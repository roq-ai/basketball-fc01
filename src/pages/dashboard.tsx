...
import { TeamManagerListPage as ShowCaseList } from 'pages/team-managers';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Team Managers
                </Text>
                <NextLink href={`team-managers`} passHref legacyBehavior>
                  <Button
