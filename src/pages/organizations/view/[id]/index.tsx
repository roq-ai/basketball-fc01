...
import { getTeamManagers, deleteTeamManagerById, createTeamManager } from 'apiSdk/team-managers';
      ...
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createTeamManager}
                deleteHandler={deleteTeamManagerById}
                fetcher={getTeamManagers}
                entity="team_manager"
                title="Team Managers"
                filters={{ organization_id: id }}
                hidePagination={true}
