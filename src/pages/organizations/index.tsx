...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'customer.count', 'player.count', 'referee.count', 'team_manager.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('referee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('team_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'team_manager',
          header: 'Team Manager',
          accessorKey: 'team_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.team_manager,
        }
      : null,
